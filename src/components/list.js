      ...
      <table className="container">
        <thead>
          <tr>
            <th>
              <h1>
                <a className="sort" onClick={() => this.sortBy('movie_title')}>
                  Movie Title
                </a>
              </h1>
            </th>
            <th>
              <h1>
                <a
                  className="sort"
                  onClick={() => this.sortBy('director_name')}
                >
                  Director Name
                </a>
              </h1>
            ...
            <th>
              <h1>
                <a className="sort" onClick={() => this.sortBy('language')}>
                  Language
                </a>
              </h1>
            </th>
            <th>
              <h1>
                <a className="sort" onClick={() => this.sortBy('country')}>
                  Country
                </a>
              </h1>
            </th>
            <th>
              <h1>
                <a
                  className="sort"
                  onClick={() => this.sortBy('content_rating')}
                >
                  Content Rating
                </a>
              </h1>
            ...
            <th>
              <h1>
                <a className="sort" onClick={() => this.sortBy('budget')}>
                  Budget($)
                </a>
              </h1>
            </th>
            <th>
              <h1>
                <a className="sort" onClick={() => this.sortBy('title_year')}>
                  Title Year
                </a>
              </h1>
            </th>
    ...
    return (
      <div>
        ...
        <div className="container">
          <a
            className="move-left move"
            href="#"
            onClick={e => this.previous(e)}
          >
            Previous
          </a>
          <a className="move-right move" href="#" onClick={e => this.next(e)}>
            Next
          </a>
        </div>
      </div>
